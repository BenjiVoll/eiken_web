            ...
            <div className="flex items-center justify-between text-white">
              <div>
                ...
                <p className="mt-1 text-blue-100 text-sm opacity-90">
                  Organiza tus productos y servicios.
                </p>
              </div>
              <button
                onClick={onClose}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50 transition-all"
                  placeholder="Ej: Impresión Large Format"
                  disabled={loading}
                  autoFocus
                />
              </div>
